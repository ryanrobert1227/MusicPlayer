...
const data = [
  ...
  },
  {
    ...
    artist: "Halsey",
    description:
      "Without Me is a powerful pop ballad by Halsey. It was released in 2018 and has resonated with listeners for its raw and honest lyrics.",
    url: withoutMe,
    lyrics: [
      {
        verse: ["Obie Trice", "Real name, no gimmicks"],
      },
      {
        verse: [
